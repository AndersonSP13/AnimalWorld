...
<head>
    ...
    <link rel="stylesheet" href="../../../css/calendario.css?v=2">
...
<div class="volver">
        <a href="../admin.php"><i class="ri-arrow-left-line"></i></a>
    </div>
...
<div id="myModal" class="modal">
  <div class="contenedor-modal">
    <h1>Agendar Cita</h1>
    <form action="guardar_cita.php" method="POST" id="formularioCita">
      <div class="mb-3">
      ...
      <select class="form-control" id="Color" name="Estado" onchange="mostrarEstadoColor()" required>
        ...
        <option value="#008000">Cita Completada</option>
        <option value="#3388ff">Cita Pendiente</option>
        <option value="#ff4733">Cita Cancelada</option>
      </select>


      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" id="cerrarModal">Cerrar</button>
        <button type="submit" class="btn btn-primary" onclick="agregarEvento()">Guardar</button>
      </div>
    </form>
...
<script src="../../../js/calendario.js?v=3"></script>
<!-- Scripts sweetalert2 -->
