...
<head>
    ...
    <!--Estilos-->
    <link rel="stylesheet" href="../../css/cliente-vacunacion.css?v=2">
...
<body>
    ...
    <section class="hero">
        <div class="hero-text">
            <h4>Servicio de</h4>
            <h1>Vacun<span class="titulo">ación</span></h1>
        </div>
    </section>
    ...
    <div class="contenedor-informacion">
        <div class="info">
            <h2>Vacunación</h2>
            <p> Nuestro proceso de vacunación es seguro y efectivo. Nos aseguramos de utilizar productos de calidad y seguir las mejores 
                prácticas en cuanto a técnicas de administración y almacenamiento de vacunas. También proporcionamos orientación y asesoramiento 
                personalizados sobre los programas de vacunación recomendados para tu mascota, adaptándonos a sus necesidades específicas</p>
        </div>
        <div class="info-img">
            <img src="../../img/servicio-vacunacion.jpg" alt="imagen de info">
        </div>
    </div>
